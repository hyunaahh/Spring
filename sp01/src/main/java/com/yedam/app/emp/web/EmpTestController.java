...
public class EmpTestController {
	...
	@ResponseBody
	public Map<String, Object> paramTestEmPost(@RequestParam String name, @RequestParam(defaultValue ="20") Integer age){
		Map<String, Object> map = new HashMap<>();
		map.put("name", name);
		map.put("age", age);
		return map;
	...
	//pathVariable 
	// 경로와 매개변수가 다를경우 name속성으로 알려주면 됨. (ex.password)
